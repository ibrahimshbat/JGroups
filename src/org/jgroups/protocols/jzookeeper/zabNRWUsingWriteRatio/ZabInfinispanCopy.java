...
public class ZabInfinispanCopy extends ReceiverAdapter {
	...
	static {
		try {
			METHODS[START]                 = ZabInfinispanCopy.class.getMethod("startTest");
			METHODS[SET_OOB]               = ZabInfinispanCopy.class.getMethod("setOOB", boolean.class);
			METHODS[SET_SYNC]              = ZabInfinispanCopy.class.getMethod("setSync", boolean.class);
			METHODS[SET_NUM_MSGS]          = ZabInfinispanCopy.class.getMethod("setNumMessages", int.class);
			METHODS[SET_NUM_THREADS]       = ZabInfinispanCopy.class.getMethod("setNumThreads", int.class);
			METHODS[SET_MSG_SIZE]          = ZabInfinispanCopy.class.getMethod("setMessageSize", int.class);
			METHODS[SET_ANYCAST_COUNT]     = ZabInfinispanCopy.class.getMethod("setAnycastCount", int.class);
			METHODS[SET_USE_ANYCAST_ADDRS] = ZabInfinispanCopy.class.getMethod("setUseAnycastAddrs", boolean.class);
			METHODS[SET_READ_PERCENTAGE]   = ZabInfinispanCopy.class.getMethod("setReadPercentage", double.class);
			METHODS[GET]                   = ZabInfinispanCopy.class.getMethod("get", long.class);
			METHODS[PUT]                   = ZabInfinispanCopy.class.getMethod("put", long.class, byte[].class);
			METHODS[GET_CONFIG]            = ZabInfinispanCopy.class.getMethod("getConfig");
			METHODS[STARTWARM]                 = ZabInfinispanCopy.class.getMethod("startWarm");
	...
	public static void main(String[] args) {
		...
		ZabInfinispanCopy test=null;
		test=new ZabInfinispanCopy();
		try {
