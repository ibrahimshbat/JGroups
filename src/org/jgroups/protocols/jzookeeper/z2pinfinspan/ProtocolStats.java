...
public class ProtocolStats {
	...
	public ProtocolStats(String protocolName, int numberOfClients,
			int numberOfSenderInEachClient, String outDir, boolean isEnabled) {
	...
	public void printProtocolStats() {
		...
		double avgAllD = 0, throughputRate =0, tempSumThr=0, per50th=0,per90th=0, per99th=0;
		...
		outFile.println("Write Latency: [Min= " + ((double) (min(writeLatencies))/1000000.0) + " Avg= " +
				avgAllD  + " Max= " +((double) (max(writeLatencies))/1000000.0)+"]");
