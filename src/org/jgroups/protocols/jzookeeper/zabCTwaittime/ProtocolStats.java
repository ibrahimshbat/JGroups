...
public class ProtocolStats {
	...
	public void printProtocolStats(int deliveredRequest, int cliuterSize, int perRW, long waitSentTime) {
		...
		outFile.println("Total Count ACKs: " + countAck.get());
	//	System.out.println("Throughput: "
		...
		outFile.println("Tail Timeout elapsed: " + countTailTimeout);
		...
		if(latencies.size()!=0){
			...
			//System.out.println("Average In NanoSec="+avgAllD);
			...
			//System.out.println("Write Latency 90th percentile: "+per90th);
		}
		...
		outFile.println("All Write Latency 95th percentile: "+per95th);
		outFile.println("All Write Latency 99th percentile: "+per99th);
		//System.out.println("All Latencies 90th percentile: "+per90th);
