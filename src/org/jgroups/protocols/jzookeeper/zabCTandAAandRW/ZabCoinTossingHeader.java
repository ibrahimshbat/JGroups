package org.jgroups.protocols.jzookeeper.zabCTandAAandRW;
...
public class ZabCoinTossingHeader extends Header {
	...
	public ZabCoinTossingHeader(MessageOrderInfo messageOrderInfo) {
		this.messageOrderInfo = messageOrderInfo;
	}
	public ZabCoinTossingHeader(byte type, MessageOrderInfo messageOrderInfo) {
		this.type=type;
		this.messageOrderInfo=messageOrderInfo;
	}
	public ZabCoinTossingHeader(byte type, Collection<MessageOrderInfo> bundledMsgInfo) {
		this.type = type;
		this.bundledMsgInfo = bundledMsgInfo;
	}

	public ZabCoinTossingHeader(byte type, MessageOrderInfo messageOrderInfo, MessageId messageId) {
		this.type=type;
		this.messageOrderInfo=messageOrderInfo;
		this.messageId=messageId;

	}
	public ZabCoinTossingHeader(byte type, long zxid, MessageOrderInfo messageOrderInfo, MessageId messageId) {
		this.type=type;
		this.zxid=zxid;
		this.messageOrderInfo=messageOrderInfo;
		this.messageId=messageId;
	...
	public ZabCoinTossingHeader(byte type, long zxid, MessageOrderInfo messageOrderInfo) {
		this(type);
		this.zxid=zxid;
		this.messageOrderInfo=messageOrderInfo;
	}
	
	public ZabCoinTossingHeader(byte type, long zxid) {
		this(type);
		this.zxid=zxid;
	}
	public ZabCoinTossingHeader(byte type, long zxid, MessageId messageId) {
		this(type);
		this.zxid=zxid;
		this.messageId=messageId;
	}

	public ZabCoinTossingHeader(byte type, long zxid, Timeout timeout) {
		this(type);
		this.zxid=zxid;
    ...
    public boolean equals(Object o) {
        ...
        ZabCoinTossingHeader that = (ZabCoinTossingHeader) o;
