...
public class ZabHeader extends Header {
	...
	public static final byte RWCHANGE = 20;
	...
	public ZabHeader(byte type, Collection<MessageOrderInfo> bundledMsgInfo) {
		this.type = type;
	...
	public ZabHeader(byte type, long zxid, Timeout timeout) {
		this(type);
		this.zxid=zxid;
