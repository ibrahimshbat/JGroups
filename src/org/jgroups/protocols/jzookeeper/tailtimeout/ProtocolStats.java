...
import org.jgroups.protocols.COUNTER.CounterHeader;
...
public class ProtocolStats {
	...
	public AtomicInteger countPendingProposal;
	...
	public ProtocolStats(String protocolName, int numberOfClients,
		...
		countPendingProposal  = new AtomicInteger(0);
...
//		}
		...
		outFile.println("The Count of tail occur:"+ countTail.get());
		...
		outFile.println("The # Pendinf Proposals: "+ countPendingProposal.get());
