...
public class SkeenHeader extends Header {
	...
	public SkeenHeader(byte type) {
		this.type=type;
	}

	public SkeenHeader(MessageOrderInfo messageOrderInfo) {
		this.messageOrderInfo = messageOrderInfo;
	}

	public SkeenHeader(byte type, MessageId id) {
		this.type=type;
		this.messageId=id;
	}

	public SkeenHeader(byte type, MessageOrderInfo messageOrderInfo) {
		this.type=type;
		this.messageOrderInfo=messageOrderInfo;
	}


	public SkeenHeader(byte type, Collection<MessageOrderInfo> bundledMsgInfo) {
		this.type = type;
		this.bundledMsgInfo = bundledMsgInfo;
	}

	public SkeenHeader(byte type, MessageOrderInfo messageOrderInfo, MessageId messageId) {
		this.type=type;
		this.messageOrderInfo=messageOrderInfo;
	...
	public SkeenHeader(byte type, long logicalClock, MessageOrderInfo messageOrderInfo, MessageId messageId) {
		this.type=type;
	...
	public SkeenHeader(byte type, long logicalClock) {
		this(type);
		this.logicalClock=logicalClock;
	}
	public SkeenHeader(byte type, long logicalClock, MessageId messageId) {
		this(type);
		this.logicalClock=logicalClock;
		this.messageId=messageId;
	}

	public SkeenHeader(byte type, long logicalClock, MessageOrderInfo messageOrderInfo) {
		this(type);
		this.logicalClock=logicalClock;
		this.messageOrderInfo=messageOrderInfo;
	}
	...
	public void writeTo(DataOutput out) throws Exception {
		out.writeByte(type);
		Bits.writeLong(logicalClock,out);
	...
	public int size() {
		...
		return Global.BYTE_SIZE + Bits.size(logicalClock) + (messageId != null ? messageId.size(): 0) +
	  ...
	  @Override
	    public boolean equals(Object o) {
	        ...
	        SkeenHeader that = (SkeenHeader) o;
