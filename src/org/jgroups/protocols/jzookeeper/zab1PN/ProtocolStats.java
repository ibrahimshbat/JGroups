...
public class ProtocolStats {
	...
	public void printProtocolStats(int deliveredRequest, int cliuterSize) {

		double avgAllD = 0, throughputRate =0, tempSumThr=0, per50th=0, per90th=0;
		String CI95=null;
		outFile.println("Info: "+protocolName + "/" + numberOfClients + "/"
				+ numberOfSenderInEachClient+"/Cluster Size=:"+cliuterSize);
		...
		outFile.println("Latency: [Min= " + ((double) (min(latencies))/1000000.0) + " Avg= " +
