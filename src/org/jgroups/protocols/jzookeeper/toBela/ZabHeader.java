...
import org.jgroups.protocols.jzookeeper.MessageOrderInfo;
...
import org.jgroups.util.Util;
    ...
    public class ZabHeader extends Header {
		...
		public ZabHeader(byte type, long zxid, MessageOrderInfo messageOrderInfo, MessageId messageId) {
            this.type=type;
            this.zxid=zxid;
            this.messageOrderInfo=messageOrderInfo;
            this.messageId=messageId;
        ...
        public ZabHeader(byte type, long zxid) {
            this(type);
            this.zxid=zxid;
        }
        public ZabHeader(byte type, long zxid, MessageId messageId) {
            this(type);
            this.zxid=zxid;
            this.messageId=messageId;
        }
        
        public ZabHeader(byte type, long zxid, MessageOrderInfo messageOrderInfo) {
            this(type);
            this.zxid=zxid;
            this.messageOrderInfo=messageOrderInfo;
        }
        ...
        public int size() {
            ...
            return Global.BYTE_SIZE + Bits.size(zxid) + (messageId != null ? messageId.size(): 0) + (messageOrderInfo != null ? messageOrderInfo.size() : 0); 
         }
