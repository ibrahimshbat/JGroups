...
final public class CSInteractionHeader extends Header {
    ...
    public static final byte RESPONSER = 1; // A response from the Z
    public static final byte RESPONSEW = 2; // A response from the Z

    public static final byte BROADCAST = 3; // Actual broadcsat of a message to anycast destinations
    public static final byte STARTWARMTEST = 4; // A response from the Z
    public static final byte STARTREALTEST = 5; // A response from the Z
    ...
    public static String type2String(int t) {
        switch(t) {
            ...
            case STARTWARMTEST:	            return "STARTWARMTEST";
