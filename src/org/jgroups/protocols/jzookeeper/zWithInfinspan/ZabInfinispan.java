...
public class ZabInfinispan extends ReceiverAdapter {
	...
	public void sendMyAddressToZab() {
		MessageId mid = new MessageId(local_addr, localSequence.incrementAndGet());
		ZabHeader startHeader = new ZabHeader(ZabHeader.SENDMYADDRESS, mid);
		Message msg = new Message(null).putHeader((short) 78, startHeader);
